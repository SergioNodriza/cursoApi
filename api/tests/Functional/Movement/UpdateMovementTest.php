...
class UpdateMovementTest extends MovementTestBase
{
    public function testUpdateMovement(): void
    {
        ...
        self::$peter->request('PUT', \sprintf('%s/%s', $this->endpoint, $this->getPeterMovementId()), [],  [], [], \json_encode($payload));
    ...
    public function testUpdateAnotherUserMovement(): void
    {
        ...
        self::$brian->request('PUT', \sprintf('%s/%s', $this->endpoint, $this->getPeterMovementId()), [],  [], [], \json_encode($payload));
    ...
    public function testUpdateAnotherGroupMovement(): void
    {
        ...
        self::$peter->request('PUT', \sprintf('%s/%s', $this->endpoint, $this->getBrianGroupMovementId()), [],  [], [], \json_encode($payload));
