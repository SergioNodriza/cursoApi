...
class DownloadFileTest extends MovementTestBase
{
    public function testDownloadFile(): void
    {
        ...
        self::$peter->request('POST', \sprintf('%s/%s/download_file', $this->endpoint, $this->getPeterMovementId()), [], [], [], \json_encode($payload));
    ...
    public function testDownloadAnotherUserFile(): void
    {
        ...
        self::$brian->request('POST', \sprintf('%s/%s/download_file', $this->endpoint, $this->getPeterMovementId()), [], [], [], \json_encode($payload));
