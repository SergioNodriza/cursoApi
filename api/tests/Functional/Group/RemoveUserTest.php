...
class RemoveUserTest extends GroupTestBase
{
    public function testRemoveUserFromGroup(): void
    {
        ...
        self::$peter->request('PUT', \sprintf('%s/%s/remove_user', $this->endpoint, $this->getPeterGroupId()), [], [], [], \json_encode($payload));
    ...
    public function testRemoveNotAMember(): void
    {
        ...
        self::$brian->request('PUT', \sprintf('%s/%s/remove_user', $this->endpoint, $this->getBrianGroupId()), [], [], [], \json_encode($payload));
    ...
    private function addUserToGroup(): void
    {
        ...
        self::$brian->request('PUT', \sprintf('%s/%s/accept_request', $this->endpoint, $this->getPeterGroupId()), [], [], [], \json_encode($payload));
    }
}