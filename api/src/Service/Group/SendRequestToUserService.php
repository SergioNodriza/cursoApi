...
use App\Exceptions\Group\NotOwnerOfGroupException;
use App\Exceptions\Group\UserAlreadyMemberOfGroup;
...
class SendRequestToUserService
{
    ...
    public function __construct(UserRepository $userRepository, GroupRepository $groupRepository, GroupRequestRepository
                                $groupRequestRepository, MessageBusInterface $messageBus)
    {
